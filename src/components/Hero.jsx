    ...
    <section id='home' className={`flex flex-col md:flex-row ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 text-white font-poppins font-semibold ss:text-[72px] text-[52px] leading-[75px] ss:leading-[100px]">
        ...
        <h1 className=" text-white font-poppins font-semibold ss:text-[68px] text-[52px] leading-[75px] ss:leading-[100px] w-full">Payment Method.</h1> 
